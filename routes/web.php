...
Route::get('/admin/importMembres',       [App\Http\Controllers\Admin\MemberImportController::class, 'form'])->middleware('can:admin:users');
Route::post('/admin/importMembres',      [App\Http\Controllers\Admin\MemberImportController::class, 'preview'])->middleware('can:admin:users');
Route::post('/admin/importMembres/save', [App\Http\Controllers\Admin\MemberImportController::class, 'save'])->middleware('can:admin:users');
...
Route::get('/admin/export/transactions',      [App\Http\Controllers\admin::class, 'exportTransactionsPage'])->middleware('can:admin:export');
Route::post('/admin/export/transactions',     [App\Http\Controllers\admin::class, 'exportTransactionsPage'])->middleware('can:admin:export');
Route::post('/admin/export/transactions/csv', [App\Http\Controllers\admin::class, 'exportTransactionsCsvDownload'])->middleware('can:admin:export');
...
Route::get('/planchesOgn', [App\Http\Controllers\OgnController::class, 'planches'])->middleware('can:admin:ogn');
